<template>
  <v-app>
    <v-content>
      ...
      <h3>個人情報の利用目的</h3>
      <p>SomuriEngineer（以下、「当サイト」とします）では、訪問者様からのお問い合わせやコメントをお受けした際に、お名前（ハンドルネール）、メールアドレス等の個人情報をご登録いただく場合がございます。</p>
      ...
      <p>当サイトでは「Amazonアソシエイト」などのアフィリエイトプログラムや第三者配信広告サービス「Google AdSense」を利用しています。</p>
      <p>Google AdSenseでは広告配信プロセスにおいてデータを収集するために、Cookieを使用しています。GoogleでCookieを使用することにより、インターネットにおけるご自身のサイトや他のサイトへのアクセス情報に基づいてユーザーに広告を配信することが可能になります。</p>
      ...
      <p>本スマホアプリの作動に係る不具合（表示情報の誤謬・逸脱、通知の不能、情報漏洩等）、スマートフォンに与える影響および契約者が本スマホアプリを正常に利用できないことにより被る不利益、その他一切の不利益について、
      ...
      <h3>お問い合わせ</h3>
      <p>当サイトへの、お問い合わせに関しては、以下メールアドレスへご連絡ください。</p>
      <p>somuriengineer@gmail.com</p>
    </v-content>
  </v-app>
</template>
